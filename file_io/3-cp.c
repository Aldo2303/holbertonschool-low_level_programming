#include "main.h"
/**
 * exit_code - function exits with corresponding value and message
 * @error: number the error asignament
 * @arg: argument (file_from | file_to) with error
 ...
 * @argc: only 3 argument: executable, file_from, file_to
 * @argv: each one of the 3 mentioned above
